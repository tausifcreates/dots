            ...
            s.mywibox:setup {
                ...
                s.mytasklist, -- Middle widget
                {
                    ...
                    battery_widget {
                        ...
                        ac_prefix = "AC: ",
                        battery_prefix = {
                            { 25, " <span color='#ff8b94'></span> " },
                            { 50, " <span color='#ffaaa5'></span> " },
                            { 75, " <span color='#ffcc5c'></span> " },
                            { 100, " <span color='#ffeead'></span> " }
                        },
                        percent_colors = {
                            { 25, "#ff8b94" },
                            { 50, "#ffaaa5" },
                        ...
                        listen = true,
                        timeout = 10,
                        widget_text = "${AC_BAT}<span color='#a8e6cf'>${state} </span>${color_on}${percent}%${color_off} ",
                        widget_font = "Iosevka Nerd Font Mono 10",
                    ...
                    volume_control {
                        ...
                        font = "Iosevka Nerd Font Mono 10", -- font used for the widget's text
                        callback = nil, -- called to update the widget: `callback(self, state)`
                        widget_text = {
                            on = " <span font='RobotoMono Nerd Font' color='#d2e7ff'></span>% 3d%% ", -- three digits, fill with leading spaces
                            off = "% 3dM "
                        },
                        tooltip_text = [[
                        Volume: ${volume}% ${state}Channel: ${channel}Device: ${device}Card: ${card}
                    ]]
                    },
                    brightness {},
                    mytextclock,
...
-- Standard program
        ...
        awful.key({ modkey, "Control", "Shift" }, "e", awesome.restart, { description = "reload awesome", group = "awesome" }),
...
-- XF86 Keys
        awful.key(
                ...
                'XF86MonBrightnessUp',
                function()
                    awful.spawn('brightnessctl set +1%', false)
                end,
